...
public class TaxCalulationTest extends TestUtils {
    ...
    public Object[][] dataProvFunc() {
        return new Object[][]{
                {true, "EUR", 250, 1027.55, null, 200},
                {true, "YYY", 250, 0, "currency not found", 400},
                {false, "EUR", 250, 0, "Unauthorized", 401},
                {true, "EUR", 500, 1392.05, null, 200}
        };
    }
    ...
    public void calculateVat(boolean isRequestValid, String currency, int quantity, double vatExpected, String expectedMessage, int responseCode) throws IOException {
...
//        System.out.println(responseCalc.getBody().jsonPath().prettify());
        ...
        switch (statusCode) {
            ...
            case 400:
                ...
                break;
            case 401:
                responseCalc.then().statusCode(401);
